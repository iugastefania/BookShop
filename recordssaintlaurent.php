...
<html>
<head>
  <title>Saint Laurent Admin</title>
</head>
<meta charset="UTF-8">
...
<head>
    ...
    * {
    ...
    <h2 class="w3-wide w3-center">Saint Laurent</h2>
...
include "dbConnsl.php"; // Using database connection file here

$records = mysqli_query($db,"select * from tblsaint"); // fetch data from database

while($data = mysqli_fetch_array($records))
{
?>
  <tr>
    <td><?php echo $data['namesl']; ?></td>
    <td><?php echo $data['lnamesl']; ?></td>
    <td><?php echo $data['subjectsj']; ?></td>
  </tr>	
<?php
}
?>
...
?>
  <tr>
    ...
    <td><a href="editsl.php?id=<?php echo $data['id']; ?>">Edit</a></td>
    <td><a href="deletebooksl.php?id=<?php echo $data['id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
...
$records = mysqli_query($db,"select * from orderssl"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="deleteordersl.php?order_id=<?php echo $data['order_id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
