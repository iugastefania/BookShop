...
$qry = mysqli_query($db,"select * from booksmv where id='$id'"); // select query
...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update booksmv set fname='$fname', description='$description' where id='$id'");
	
    if($edit)
    {
        mysqli_close($db); // Close connection
        header("location:recordmadeleinevionnet.php"); // redirects to all records page
        exit;
    }
    else
    {
