...
$link6 = mysqli_connect("localhost", "root", "", "laurent");
...
$namesl = mysqli_real_escape_string($link6, $_REQUEST['namesl']);
$lnamesl = mysqli_real_escape_string($link6, $_REQUEST['lnamesl']);
$subjectsj = mysqli_real_escape_string($link6, $_REQUEST['subjectsj']);
 
// Attempt insert query execution
$sql6 = "INSERT INTO tblsaint (namesl, lnamesl, subjectsj) VALUES ('$namesl', '$lnamesl', '$subjectsj')";
if(mysqli_query($link6, $sql6)){
    echo "Feedback added successfully.";
} else{
    echo "ERROR: Could not able to execute $sql6. " . mysqli_error($link6);
}
