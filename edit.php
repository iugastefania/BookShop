...
$qry = mysqli_query($db,"select * from books where id='$id'"); // select query
...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update books set fname='$fname', description='$description' where id='$id'");
	
    if($edit)
    {
        mysqli_close($db); // Close connection
        header("location:recordschristiandior.php"); // redirects to all records page
        exit;
    }
    else
    {
