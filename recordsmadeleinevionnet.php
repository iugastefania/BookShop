...
<html>
<head>
  <title>Madeleine Vionnet Admin</title>
</head>
<meta charset="UTF-8">
...
<head>
    ...
    * {
    ...
    <h2 class="w3-wide w3-center">Madeleine Vionnet</h2>
...
include "dbConnmv.php"; // Using database connection file here

$records = mysqli_query($db,"select * from tlmadeleinevionnet"); // fetch data from database

while($data = mysqli_fetch_array($records))
{
?>
  <tr>
    <td><?php echo $data['namemadeleine']; ?></td>
    <td><?php echo $data['lnamemadeleine']; ?></td>
    <td><?php echo $data['subjectmadeleine']; ?></td>
  </tr>	
<?php
}
?>
...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($db,"insert into booksmv(fname,description,images) values('$_POST[fname]', '$_POST[description]','$dst_db')");  // executing insert query
...
$records = mysqli_query($db,"select * from booksmv"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="editmv.php?id=<?php echo $data['id']; ?>">Edit</a></td>
    <td><a href="deletebookmv.php?id=<?php echo $data['id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
...
$records = mysqli_query($db,"select * from ordersmv"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="deleteordermv.php?order_id=<?php echo $data['order_id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
