...
<html>
<head>
  <title>Elsa Schiaparelli Admin</title>
</head>
<meta charset="UTF-8">
...
include "dbConnes.php"; // Using database connection file here

$records = mysqli_query($db,"select * from tblelsaschiaparelli"); // fetch data from database

while($data = mysqli_fetch_array($records))
{
?>
  <tr>
    <td><?php echo $data['nameelsaschiaparelli']; ?></td>
    <td><?php echo $data['lnameelsaschiaparelli']; ?></td>
    <td><?php echo $data['subjectelsaschiaparelli']; ?></td>
  </tr>	
<?php
}
?>
...
?>
  <tr>
    ...
    <td><a href="edites.php?id=<?php echo $data['id']; ?>">Edit</a></td>
    <td><a href="deletebookes.php?id=<?php echo $data['id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
...
$records = mysqli_query($db,"select * from orderses"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="deleteorderes.php?order_id=<?php echo $data['order_id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
