...
<div class="w3-top">
 ...
 <head>
    ...
    * {
    ...
    <h2 class="w3-wide w3-center">Paul Poiret</h2>
...
include "dbConnpp.php"; // Using database connection file here

$records = mysqli_query($db,"select * from bpaulpoiret"); // fetch data from database

while($data = mysqli_fetch_array($records))
{
?>
  <tr>
    <td><?php echo $data['namepoiret']; ?></td>
    <td><?php echo $data['lnamepoiret']; ?></td>
    <td><?php echo $data['subjectpoiret']; ?></td>
  </tr>	
<?php
}
?>
...
?>
  <tr>
    ...
    <td><a href="editpp.php?id=<?php echo $data['id']; ?>">Edit</a></td>
    <td><a href="deletebookpp.php?id=<?php echo $data['id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
...
$records = mysqli_query($db,"select * from orderspp"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="deleteorderpp.php?order_id=<?php echo $data['order_id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
