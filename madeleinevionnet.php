...
<head>
  ...
  <div class="container">
      <form action="vionnet.php" method="post">
        <label for="namemadeleine" class="email">First Name</label>
        <input type="text" name="namemadeleine" placeholder="Your name..">
    
        <label for="lnamemadeleine" class="email">Last Name</label>
        <input type="text" name="lnamemadeleine" placeholder="Your last name..">
    
    
        <label for="subjectmadeleine" class="email">Subject</label>
        <textarea id="subjectmadeleine" name="subjectmadeleine" placeholder="Write something.." style="height:200px"></textarea>
