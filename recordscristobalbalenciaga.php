...
<html>
<head>
  <title>Cristóbal Balenciaga Admin</title>
</head>
<meta charset="UTF-8">
...
<body>
<h2 class="w3-wide w3-center">Cristóbal Balenciaga</h2>
...
include "dbConncb.php"; // Using database connection file here

$records = mysqli_query($db,"select * from tbcristobalbalenciaga"); // fetch data from database

while($data = mysqli_fetch_array($records))
{
?>
  <tr>
    <td><?php echo $data['namecristobal']; ?></td>
    <td><?php echo $data['lnamecristobal']; ?></td>
    <td><?php echo $data['subjectcristobal']; ?></td>
  </tr>	
<?php
}
?>
...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($db,"insert into bookscb(fname,description,images) values('$_POST[fname]', '$_POST[description]','$dst_db')");  // executing insert query
...
$records = mysqli_query($db,"select * from bookscb"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="editcb.php?id=<?php echo $data['id']; ?>">Edit</a></td>
    <td><a href="deletebookcb.php?id=<?php echo $data['id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
...
$records = mysqli_query($db,"select * from orderscb"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="deleteordercb.php?order_id=<?php echo $data['order_id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
