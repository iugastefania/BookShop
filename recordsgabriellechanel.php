...
<html>
<head>
  <title>Gabrielle Chanel Admin</title>
</head>
<meta charset="UTF-8">
...
<head>
    ...
    * {
    ...
    <h2 class="w3-wide w3-center">Gabrielle Chanel</h2>
...
include "dbConngc.php"; // Using database connection file here

$records = mysqli_query($db,"select * from tblgabriellechanel"); // fetch data from database

while($data = mysqli_fetch_array($records))
{
?>
  <tr>
    <td><?php echo $data['namegabriellechanel']; ?></td>
    <td><?php echo $data['lnamegabriellechanel']; ?></td>
    <td><?php echo $data['subjectgabriellechanel']; ?></td>
  </tr>	
<?php
}
?>
...
?>
  <tr>
    ...
    <td><a href="editgc.php?id=<?php echo $data['id']; ?>">Edit</a></td>
    <td><a href="deletebookgc.php?id=<?php echo $data['id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
...
$records = mysqli_query($db,"select * from ordersgc"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="deleteordergc.php?order_id=<?php echo $data['order_id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
