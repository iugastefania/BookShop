...
$qry = mysqli_query($db,"select * from bookspp where id='$id'"); // select query
...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update bookspp set fname='$fname', description='$description',  new='$new' where id='$id'");
