...
$qry = mysqli_query($db,"select * from booksgc where id='$id'"); // select query
...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update booksgc set fname='$fname', description='$description' where id='$id'");
	
    if($edit)
    {
        mysqli_close($db); // Close connection
        header("location:recordsgabriellechanelr.php"); // redirects to all records page
        exit;
    }
    else
    {
