...
$qry = mysqli_query($db,"select * from booksjl where id='$id'"); // select query
...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update booksjl set fname='$fname', description='$description', new='$new' where id='$id'");
...
<form method="POST">
  ...
  <input type="text" name="new" value="<?php echo $data['new'] ?>" placeholder="Enter Description" Required>
