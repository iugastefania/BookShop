...
<html>
<head>
  <title>Christian Dior Admin</title>
</head>
<meta charset="UTF-8">
...
include "dbConncd.php"; // Using database connection file here

$records = mysqli_query($db,"select * from feedbackdior"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="deletebookcd.php?id=<?php echo $data['id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
...
$records = mysqli_query($db,"select * from orders"); // fetch data from database
...
?>
  <tr>
    ...
    <td><a href="deleteordercd.php?order_id=<?php echo $data['order_id']; ?>">Delete</a></td>
  </tr>	
<?php
}
?>
